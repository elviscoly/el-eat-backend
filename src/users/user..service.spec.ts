...
describe('UserService', () => {
  ...
  describe('createAccount',  () => {
    ...
    it('should fail when the user exists', async () => {
      usersRepository.findOne.mockResolvedValue({
        id:1,
        email:"elviscoly2017@gmail.com"
      });
  ...
  describe('editProfile', () => {
    ...
    it('should change email', async () => {
      const oldUser = {
        email: 'elviscoly@gmail.com',
        verified: true,
      };
      const editProfileArgs = {
        userId: 1, 
       input: { email: 'elviscoly2017@gmail.com'},
      };
    ...
    it('should change password', async () => {
      ...
      usersRepository.findOne.mockResolvedValue({password: '123456'});
  ...
  describe('verifyEmail', () => {
    it('should verify email', async () => {
     ...
     const result = await service.verifyEmail('');
      ...
      expect(verificationsRepository.findOne).toHaveBeenLastCalledWith(
        expect.any(Object),
        expect.any(Object),
        );
      expect(usersRepository.save).toHaveBeenCalledTimes(1);
      expect(usersRepository.save).toHaveBeenLastCalledWith({verified: true});
      expect((verificationsRepository.delete)).toHaveBeenCalledTimes(1);
      expect(verificationsRepository.delete).toHaveBeenLastCalledWith(mockVerification.id);
